...
# @ConfigModifierRegistry.register("swin_t_upper")
# def modify_swin_upper_t(cfg, cfg_path_end)
#     return modfiy_swin_upper_segmentation(cfg, )
...
def modfiy_swin_upper_segmentation(settings, cfg_path_end="swin_s_upper.py"):
    ...
    data_preprocessor = dict(
        ...
        mean=None if backend == "tifffile" else None,  # [123.675, 116.28, 103.53],
        std=None if backend == "tifffile" else None,  # [58.395, 57.12, 57.375],
...
@ConfigModifierRegistry.register("maskrcnn_r50")
def modfiy_maskrcnn_r50(settings, cfg_path_end="mask_rcnn_r50.py"):
    backend = settings["backend"]
    ...
    swin_dict = {
        ...
        "model.roi_head.bbox_head.num_classes": settings["num_classes"],
        "model.roi_head.mask_head.num_classes": settings["num_classes"],
